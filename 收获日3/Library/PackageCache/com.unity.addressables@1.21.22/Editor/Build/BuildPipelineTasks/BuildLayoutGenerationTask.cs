...
#pragma warning restore 649
        ...
        private LayoutLookupTables GenerateLookupTables(AddressableAssetsBuildContext aaContext)
        {
            ...
            foreach (BuildLayout.File file in lookup.Files.Values)
            {
                ...
                {
                    BuildLayout.ExplicitAsset sceneAsset = file.Assets.First(x => (x.AssetPath.EndsWith(".unity", StringComparison.OrdinalIgnoreCase)|| x.AssetPath.EndsWith(".scene", StringComparison.OrdinalIgnoreCase)));
